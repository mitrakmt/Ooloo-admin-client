...
const asyncAdmins = asyncLoader(() =>
  require("../../containers/admins/admins")
);
const asyncSchools = asyncLoader(() =>
  require("../../containers/schools/schools")
);
const asyncQuestions = asyncLoader(() =>
  require("../../containers/questions/questions")
);
const asyncInterests = asyncLoader(() =>
  require("../../containers/interests/interests")
);
